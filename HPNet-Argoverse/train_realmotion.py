...
from datamodules.historical_prediction_datamodule import HistoricalPredictionDataModule
...
if __name__ == '__main__':
    ...
    # 新增历史预测相关参数（借鉴 RealMotion）
    parser.add_argument('--historical_window', type=int, default=3, help='历史预测窗口大小')
    HPNet.add_model_specific_args(parser)
    args = parser.parse_args()

    print("=" * 50)
    print("HPNet with RealMotion Integration Training")
    print("=" * 50)
    ...
    datamodule = HistoricalPredictionDataModule(**vars(args))
